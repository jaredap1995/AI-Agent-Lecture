...
response_schemas = [name_schema, dob_schema, age_schema, color_schema]
...
def main():
    questions = [
        "My name is John Doe, I'm 30 years old, my favorite color is green.",
        "What is the capital of France?",   
        "Hello, I’m Alice, 25 years old, my favorite color is blue.",
    ]
